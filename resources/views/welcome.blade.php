...
<div class="container-fluid p-0 pb-5 " data-wow-delay="0.1s">
    <div class="owl-carousel header-carousel position-relative">
                    ...
                    <div class="row justify-content-start">
                        <div class="col-lg-8">
                            ...
                            <div class="alert alert-light border-0" id="alert" style="display: none" >
                                <p class="text-primary mb-0">This is an alert</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="{{asset('storage/images/Marocain2.jpg')}}" alt="">
            <div class="owl-carousel-inner">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-lg-8">
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 " data-wow-delay="0.3s">
                <div class="product-item d-flex flex-column bg-white rounded overflow-hidden h-100">
                    <div class="text-center p-4">
                        <div class="d-inline-block border border-primary rounded-pill pt-1 px-3 mb-3">DH100-999DH</div>
            ...
            <div class="col-lg-4 col-md-6 " data-wow-delay="0.5s">
                <div class="product-item d-flex flex-column bg-white rounded overflow-hidden h-100">
                    ...
                    <div class="position-relative mt-auto">
                        <img class="img-fluid" src="{{asset('storage/images/decoration1.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-5">
            <div class="col-lg-6 " data-wow-delay="0.1s">
                ...
                <div class="row gy-5 gx-4">
                    ...
                    <div class="col-sm-6 " data-wow-delay="0.2s">
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-shrink-0 btn-square bg-primary rounded-circle me-3">
                    ...
                    <div class="col-sm-6 " data-wow-delay="0.4s">
                        <div class="d-flex align-items-center mb-3">
                            <div class="flex-shrink-0 btn-square bg-primary rounded-circle me-3">
...
<script>
    var btn = document.getElementById("hind");

    btn.addEventListener("mouseover", function() {
        btn.textContent = "This is my btn";
    });
    btn.addEventListener("mouseout", function() {
